        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              <div dangerouslySetInnerHTML={{ 
                __html: getBlockContent('text-6', '<h3 style="font-size: 24px; font-weight: bold; margin-bottom: 16px; color: #ffffff;">Attendance Tracking</h3><p style="color: #d1d5db;">Monitor employee attendance and work hours with easy check-in/check-out system</p>')
              }} />
            </div>

            {/* Feature Card 6 - User Management */}
            <div className="p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
              ...
              <div dangerouslySetInnerHTML={{ 
                __html: getBlockContent('text-7', '<h3 style="font-size: 24px; font-weight: bold; margin-bottom: 16px; color: #ffffff;">User Management</h3><p style="color: #d1d5db;">Role-based access control with secure authentication and authorization</p>')
              }} />
            </div>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-white py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 pt-8 border-t border-gray-800 text-center text-gray-400">
            <p>&copy; 2024 MiniERP. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
